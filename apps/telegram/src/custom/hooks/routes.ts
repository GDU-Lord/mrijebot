...
export function routeCallback(buttons: buttonsGenerator, value: any, procedure: procedure, waitFor: string | null = null) {
...
export function routeCallbackArray(buttons: buttonsGenerator, value: any[], procedure: procedure, waitFor: string | null = null) {
...
export function routeCallbackExcept(buttons: buttonsGenerator, value: any, procedure: procedure, waitFor: string | null = null) {
...
export function routeCallbackExceptArray(buttons: buttonsGenerator, value: any[], procedure: procedure, waitFor: string | null = null) {
